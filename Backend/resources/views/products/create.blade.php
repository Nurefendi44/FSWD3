    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Tambah Produk Galoo Store</h5>
                <hr />
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        <label for="specification" class="form-label">Spesifikasi Produk</label>
                                        <textarea name="specification" class="form-control" id="specificationTextarea" rows="3"></textarea>
                                    </div>
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="variant" class="form-control" data-role="tagsinput" value="">
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn bg-success text-white">Save Product</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
