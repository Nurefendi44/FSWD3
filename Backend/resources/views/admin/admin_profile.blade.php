                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ (!empty($adminData->profile_photo_path))
                                        ? url('img/admin_images/'.$adminData->profile_photo_path)
                                        : url('img/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 " width="110">
                                    <div class="mt-3">
                                        <h4>{{ $adminData->first_name }} {{ $adminData->last_name }}</h4>
                                        <p class="text-secondary mb-1">{{ $adminData->email }}</p>
                                        <p class="text-muted font-size-sm">By Galoo, Indonesia</p>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary">https://galoosotore.com</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary">Galoostore</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary">@koperasi_sahaja</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="card-body">
                                <form action="{{ route('user.profile.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input name="name" type="text" class="form-control" value="{{ $adminData->name }}" disabled />
                                            @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        ? url('img/admin_images/'.$adminData->profile_photo_path)
                                        : url('img/no_image.jpg') }}" alt="profile_preview" class="img-thumbnail shadow-sm" width="110">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3"></div>
                                        <div class="col-sm-9 text-secondary">
                                            <span class="btn btn-success px-4" id="btn-edit">Edit</span>
                                            <input type="submit" class="btn btn-success px-4" style="display: none" id="btn-update" value="Update" />
                                        </div>
                                    </div>
                                </form>
                            </div>
